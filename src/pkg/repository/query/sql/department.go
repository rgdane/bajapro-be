...
func NewDepartmentRepository() adapter.DepartmentRepository {
...
func (repo *departmentRepository) WithTx(tx *gorm.DB) adapter.DepartmentRepository {
	clone := repo.clone()
	clone.db = tx
	return clone
}

func (repo *departmentRepository) WithPreloads(preloads ...string) adapter.DepartmentRepository {
	clone := repo.clone()
	clone.preloads = append(clone.preloads, preloads...)
	return clone
}

func (repo *departmentRepository) WithAssociations(associations ...string) adapter.DepartmentRepository {
	clone := repo.clone()
	clone.associations = append(clone.associations, associations...)
	return clone
}

func (repo *departmentRepository) WithReplacements(replacements map[string]interface{}) adapter.DepartmentRepository {
	clone := repo.clone()
	clone.replacements = replacements
	return clone
}

func (repo *departmentRepository) WithJoins(joins ...string) adapter.DepartmentRepository {
	clone := repo.clone()
	clone.joins = append(clone.joins, joins...)
	return clone
}

func (repo *departmentRepository) WithWhere(query interface{}, args ...interface{}) adapter.DepartmentRepository {
	clone := repo.clone()
...
func (repo *departmentRepository) WithOrder(order string) adapter.DepartmentRepository {
	clone := repo.clone()
	clone.order = order
	return clone
}

func (repo *departmentRepository) WithLimit(limit int) adapter.DepartmentRepository {
	clone := repo.clone()
	clone.limit = &limit
	return clone
}

func (repo *departmentRepository) WithCursor(cursor int) adapter.DepartmentRepository {
	clone := repo.clone()
	clone.cursor = &cursor
	return clone
}

func (repo *departmentRepository) WithUnscoped() adapter.DepartmentRepository {
	clone := repo.clone()
	clone.unscoped = true
	return clone
}
